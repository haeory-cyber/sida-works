    ...
    if df_s is not None:
        ...
        if s_item and s_qty and s_amt:
            ...
            if s_item:
                ...
                # =======================================================
                # [시다의 이중 이름표 전략]
                # 1. __display_name: 화면 표시용 (벌크는 반드시 살린다)
                # 2. __clean_parent: 문자용 (벌크를 지워서 합친다)
                # =======================================================
            ...
            # =======================================================
            # [집계 1: 화면 표시용] 
            # 그룹핑 키: [__display_name] -> 벌크가 살아있어서 따로 집계됨
            # =======================================================
            ...
            # 여기서 '__display_name'을 '상품명'으로 보여줌
            ...
            # [정렬 핵심] 부모이름(__clean_parent) -> 본인이름(상품명)
            # 가지(부모:가지) -> 가지(벌크)(부모:가지) -> 감자(부모:감자) 순서로 나열됨
